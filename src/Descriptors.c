 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"Nitrokey");
...
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"NK TRNG-SERIAL");
